...
@NgModule({declarations: [
    AppComponent,PrincipalComponent,NavbarComponent,ListEstudianteComponent,
    RegistroEstudianteComponent,FondoComponent,
  ],

  imports: [
    BrowserModule,MatTableModule,MatInputModule,AppRoutingModule,HttpClientModule,
    ToastrModule.forRoot(),FormsModule,BrowserAnimationsModule,
  ],
